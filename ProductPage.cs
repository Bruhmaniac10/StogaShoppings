...
public partial class ProductPage : ContentPage, INotifyPropertyChanged
{
    ...
    public static void AddToCartClicked(object sender, EventArgs e)
    {
        if (sender is Button button && button.BindingContext is Product selectedProduct)
        {

            ((ProductPage)Application.Current.MainPage.BindingContext).cart.AddToCart(selectedProduct);
        }
    }
    ...
    private System.Collections.IEnumerable cartItems;

    public System.Collections.IEnumerable CartItems { get => cartItems; set => SetProperty(ref cartItems, value); }

    private void OnSellClicked(System.Object sender, EventArgs e)
    {
