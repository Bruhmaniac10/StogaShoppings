...
public partial class UserPage
{
    ...
    public async void InitialUserList()
    {
        ...
        users.Add(new User() { UserId = 1, Username = "LilyJiang", Password = "NewJeansLover", PaymentInfo = 0101010101, Address = "Korea", ProfilePhoto = "amongus.png" });
        ...
        users.Add(new User() { UserId = 46, Username = "EmmaJohnson", Password = "RubyGrove789", PaymentInfo = 888888888, Address = "Ivory Coast", ProfilePhoto = "rubygrove.jpg" });
